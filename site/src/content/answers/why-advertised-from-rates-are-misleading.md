---
question: "Why are advertised 'from' interest rates on asset finance often misleading?"
...
keyFacts:
  ...
  - { label: "24-month indicative rate", value: "7.49%" }
  - { label: "36-60 month indicative rate", value: "6.89%" }
  - { label: "Typical broker commission loading", value: "1-2%, about $3,000-$6,000 on a $100,000 deal" }
related: ["how-much-do-asset-finance-brokers-charge", "asset-finance-interest-rates-australia", "how-the-800-dollar-flat-fee-works"]
sources:
  - { label: "ASIC Moneysmart", url: "https://moneysmart.gov.au" }
faq:
  - { q: "Is the 'from' rate the rate I will actually get?", a: "Not necessarily. It usually reflects the shortest term and lowest-risk profile a lender offers. Your actual rate depends on the term you choose, the asset and your application." }
  - { q: "Does a longer loan term always mean a higher rate?", a: "Not with AssetMX's tiers. The 36 to 60 month tier is priced lower than the 12 month tier, so the shortest term is not automatically the cheapest." }
  - { q: "How do I know if commission is loaded into my rate?", a: "Ask whether the rate quoted is the lender's base rate or includes a broker margin. AssetMX shows the lender rate and its $800 fee as two separate line items." }
---
...
Compare the full tier structure and fee breakdown on the [rates](/rates) page, or see [how the $800 flat fee works](/answers/how-the-800-dollar-flat-fee-works).
