---
question: "Why do I need to be GST registered to get low-doc asset finance?"
...
keyFacts:
  ...
  - { label: "Other hard requirements", value: "At least one director/guarantor; business use of the asset" }
  - { label: "GST claim on chattel mortgage", value: "Usually claimable upfront (cash basis) or on the next BAS (accruals)" }
related: ["low-doc-asset-finance-requirements", "documents-needed-low-doc-asset-finance", "is-asset-finance-tax-deductible"]
sources:
  - { label: "ATO", url: "https://www.ato.gov.au" }
  - { label: "ABN Lookup (Australian Business Register)", url: "https://abr.business.gov.au" }
faq:
  - { q: "What if my business is not registered for GST?", a: "Low-doc asset finance policy requires GST registration, so an application without it will not fit this policy. Speak with the lender about alternative documentation options." }
  - { q: "Does GST registration mean I get a better rate?", a: "Not directly. It is an eligibility requirement rather than a rate factor, though it is one of the checks used to confirm the application fits low-doc policy." }
  - { q: "Can I claim the GST back on the asset I finance?", a: "Under a chattel mortgage, GST on the purchase can usually be claimed upfront on your BAS if you report on a cash basis, or on the next BAS if you report on an accruals basis." }
---
...
See the full eligibility checklist on [low-doc asset finance requirements](/answers/low-doc-asset-finance-requirements), or check your registration on [ABN Lookup](https://abr.business.gov.au).
