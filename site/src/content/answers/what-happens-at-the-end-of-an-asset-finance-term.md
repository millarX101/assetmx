---
question: "What happens at the end of an asset finance term?"
...
keyFacts:
  ...
  - { label: "2-year term max balloon", value: "60% of asset value" }
  - { label: "3-year term max balloon", value: "50% of asset value" }
  - { label: "4-year term max balloon", value: "40% of asset value" }
  - { label: "5-year+ term max balloon", value: "30% of asset value" }
related: ["what-is-a-balloon-payment", "chattel-mortgage-vs-finance-lease", "asset-finance-vs-business-loan"]
sources:
  - { label: "ASIC Moneysmart", url: "https://moneysmart.gov.au" }
faq:
  - { q: "Can I pay off an asset finance loan early?", a: "Early payout is allowed on chattel mortgages. A lender break cost applies and the amount varies, so it is worth confirming with the lender before deciding." }
  - { q: "Is the balloon calculated on what I borrowed or the asset's value?", a: "The balloon is calculated on the asset's value, not the amount financed, so it is set with reference to what the asset is worth rather than the loan size." }
  - { q: "What if the asset is worth less than the balloon when the term ends?", a: "This is a risk with any balloon structure. Speak with your lender well before the term ends about refinancing or trade options if you are concerned about the asset's likely value." }
---
...
For more on how balloons work day to day, see [what is a balloon payment](/answers/what-is-a-balloon-payment), or compare structures on [chattel mortgage vs finance lease](/answers/chattel-mortgage-vs-finance-lease).
