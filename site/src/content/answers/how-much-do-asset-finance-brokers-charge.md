---
question: "How much do asset finance brokers charge?"
...
keyFacts:
  ...
  - { label: "Cost on a $100,000 deal", value: "Roughly $3,000 to $6,000" }
  - { label: "Example origination fee", value: "$990" }
  - { label: "AssetMX platform fee", value: "$800 flat, no commission" }
related: ["how-the-800-dollar-flat-fee-works", "asset-finance-interest-rates-australia", "why-advertised-from-rates-are-misleading", "what-is-low-doc-asset-finance"]
sources:
  - { label: "ASIC Moneysmart", url: "https://moneysmart.gov.au" }
faq:
  - { q: "Is broker commission disclosed on the loan contract?", a: "Commission loaded into the rate is not usually itemised as a separate line item the way a flat fee is, which is why it can be harder to see than an upfront fee." }
  - { q: "Does AssetMX take commission from the lender?", a: "No. AssetMX charges a flat $800 fee to the customer and shows the lender's base rate separately, with no hidden commission loaded into the rate." }
  - { q: "Why would a lower rate still cost more overall?", a: "Because the fee and the rate are two separate costs. A broker-loaded rate can look like \"just a rate\" while adding thousands of dollars over the life of the loan, more than a flat fee would." }
---
...
## Where to next
See exactly how the fee is applied at [how the $800 flat fee works](/answers/how-the-800-dollar-flat-fee-works), or compare current lender rate tiers at [asset finance interest rates in Australia](/answers/asset-finance-interest-rates-australia).
