...
import { Search, Eye, Clock, FileText, FileSpreadsheet, Download } from 'lucide-react';
import { downloadApplicationHTML } from '@/lib/applicationExport';
                        ...
                        <TableCell className="text-right">
                          <div className="flex justify-end gap-1">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={() => downloadApplicationHTML({
                                ...app,
                                gst_registered_date: undefined,
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      onClick={() => downloadApplicationHTML({
                        ...
                        gst_registered_date: undefined,
                        asset_category: undefined,
                        directors: selectedApp.directors?.map(d => ({
                          ...d,
                          dob: d.dob || d.dateOfBirth || '',
                        })) || [],
                      })}
